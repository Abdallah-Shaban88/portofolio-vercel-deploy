...
export const metadata: Metadata = {
  ...
  description: "خبرة اكثر من 10 سنوات في مجال تركيبات السيراميك والرخام",
   keywords: ["ارضيات سيراميك","ارضيات رخام","تركيب رخام","تركيب سيراميك","فني تركيب سيراميك","بلاط","رخام",'سيراميك',"معلم سيراميك بالرياض","معلم رخام بالرياض","فني سيراميك و رخام","الرياض","رخام و سيراميك"]
};
